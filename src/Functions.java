...
//            scheduler.scheduleEvent(action.entity, action.entity.createAnimationAction(Math.max(action.repeatCount - 1, 0)), action.entity.getAnimationPeriod());
//        }
//    }
//
...
//        if (entity.health <= 0) {
//            Entity stump = createStump(STUMP_KEY + "_" + entity.id, entity.position, imageStore.getImageList(STUMP_KEY));
//
//            world.removeEntity(scheduler, entity);
//
...
//            Entity tree = createTree(TREE_KEY + "_" + entity.id, entity.position, getNumFromRange(TREE_ACTION_MAX, TREE_ACTION_MIN), getNumFromRange(TREE_ANIMATION_MAX, TREE_ANIMATION_MIN), getIntFromRange(TREE_HEALTH_MAX, TREE_HEALTH_MIN), imageStore.getImageList(TREE_KEY));
//
//            world.removeEntity(scheduler, entity);
//
